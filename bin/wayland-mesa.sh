...
VERSION=2
TAG=wayland-mesa-i386-v2
ASSET=nucore-wayland-mesa-i386-v2.tar.xz
SHA256=7c2cb5b98fc22ef0032672e8cd6128c878be82356c1f47a8122eee2e3c71ec78
...
install_pack() {
    ...
    command -v tar >/dev/null 2>&1 || {
        echo "wayland-mesa.sh: tar with xz support is required" >&2; exit 3;
    }
